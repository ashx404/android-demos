...
const introText =
  "This text from Tabris, WebView below using Spectre.css for responsive images and video.";

const logo =
  "https://eclipsesource.com/wp-content/uploads/2015/10/tabris-icon-logo-small.png";

const youtubeURL = "TWcyIpul8OE";

const relatedImage =
  "https://edge.alluremedia.com.au/m/g/2017/05/SAM_0023-01-1.jpeg";

const mainHeading = "Surface Studio";

const mainDescription =
  "Microsoft Surface Studio is a new category of device, designed to put you at the center of the creative process.";
